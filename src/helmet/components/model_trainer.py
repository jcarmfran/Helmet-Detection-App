...
from src.helmet.utils.common import load_object
from src.helmet.ml.models.model_optimizer import model_optimizer
from src.helmet.entity.config_entity import ModelTrainerConfig
from src.helmet.entity.artifacts_entity import DataTransformationArtifacts, ModelTrainerArtifacts
from src.helmet.ml.detection.engine import train_one_epoch, evaluate
    ...
    def initiate_model_trainer(self,) -> ModelTrainerArtifacts:
        ...
        try:
            ...
            for epoch in range(self.model_trainer_config.EPOCH):
                # self.train(model, optimizer, train_loader, self.model_trainer_config.DEVICE, epoch)
